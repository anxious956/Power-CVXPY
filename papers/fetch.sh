...
echo
echo "Known gaps, see papers/README.md section F. Get these through the NJIT library or selinc.com:"
echo "  - Taylor & Dominguez-Garcia, 'Active Fault Detection in Static Systems', IEEE TAC 70(8), 2025"
echo "  - Campbell & Nikoukhah, 'Auxiliary Signal Design for Failure Detection', Princeton UP 2004"
echo "  - Kasztenny 2022, distance elements near unconventional sources"
echo "  - Kasztenny, Fischer & Hooshyar 2026, 'From complexity to consistency'"
